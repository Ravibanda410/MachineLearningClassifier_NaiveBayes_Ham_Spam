# -*- coding: utf-8 -*-
"""
Created on Sun Aug 30 11:54:20 2020
...
email_data = pd.read_csv("C:/RAVI/Data science/Assignments/Naive Bayes-Machine learning techinque/Datasets/sms_raw_NB.csv")


##Cleaning data
import re
stop_words = []
with open("C:/RAVI/positivenegativestopwords/stop.txt") as f:
    stop_words = f.read()
